...
from rag_modules.langgraph_workflow import GraphRAGWorkflow
...
class AdvancedGraphRAGSystem:
    ...
    def initialize_system(self):
        ...
        try:
            ...
            self.workflow = GraphRAGWorkflow(self.query_router, self.config)
    ...
    def ask_question_with_routing(self, question: str, stream: bool = False, explain_routing: bool = False):
        ...
        try:
            # 1. 智能路由检索
            print("执行智能查询路由...")
            relevant_docs, analysis = self.workflow.run(question)
